    ...
    <section className="py-28 px-6 bg-[#f5f0e8] text-center relative overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <a href="https://wa.me/923325174988?text=Hello!%20I%20am%20interested%20in%20a%20tour%20to%20Gilgit%20Baltistan." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#25D366] text-white px-6 py-3.5 text-xs tracking-[0.10em] uppercase hover:bg-[#1fb855] transition-colors">
          ...
          <a href="tel:+923325174988" className="border border-[#0f0e0c]/25 text-[#0f0e0c]/70 px-6 py-3.5 text-xs tracking-[0.10em] uppercase hover:border-[#c9a84c] hover:text-[#c9a84c] transition-colors">
            Call Us
          </a>
        </div>
      </div>
